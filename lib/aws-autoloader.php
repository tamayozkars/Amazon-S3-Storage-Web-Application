...
$mapping = array(
    ...
    'Aws\data\autoscaling\2011-01-01\docs-2.json' => __DIR__ . '/Aws/data/autoscaling/2011-01-01/docs-2.json.php',
    ...
    'Aws\data\cloudformation\2010-05-15\docs-2.json' => __DIR__ . '/Aws/data/cloudformation/2010-05-15/docs-2.json.php',
    ...
    'Aws\data\cloudfront\2015-07-27\docs-2.json' => __DIR__ . '/Aws/data/cloudfront/2015-07-27/docs-2.json.php',
    ...
    'Aws\data\cloudhsm\2014-05-30\docs-2.json' => __DIR__ . '/Aws/data/cloudhsm/2014-05-30/docs-2.json.php',
    'Aws\data\cloudsearch\2013-01-01\api-2.json' => __DIR__ . '/Aws/data/cloudsearch/2013-01-01/api-2.json.php',
    'Aws\data\cloudsearch\2013-01-01\docs-2.json' => __DIR__ . '/Aws/data/cloudsearch/2013-01-01/docs-2.json.php',
    ...
    'Aws\data\cloudsearchdomain\2013-01-01\docs-2.json' => __DIR__ . '/Aws/data/cloudsearchdomain/2013-01-01/docs-2.json.php',
    'Aws\data\cloudtrail\2013-11-01\api-2.json' => __DIR__ . '/Aws/data/cloudtrail/2013-11-01/api-2.json.php',
    'Aws\data\cloudtrail\2013-11-01\docs-2.json' => __DIR__ . '/Aws/data/cloudtrail/2013-11-01/docs-2.json.php',
    ...
    'Aws\data\codecommit\2015-04-13\docs-2.json' => __DIR__ . '/Aws/data/codecommit/2015-04-13/docs-2.json.php',
    ...
    'Aws\data\codedeploy\2014-10-06\docs-2.json' => __DIR__ . '/Aws/data/codedeploy/2014-10-06/docs-2.json.php',
    ...
    'Aws\data\codepipeline\2015-07-09\docs-2.json' => __DIR__ . '/Aws/data/codepipeline/2015-07-09/docs-2.json.php',
    'Aws\data\cognito-identity\2014-06-30\api-2.json' => __DIR__ . '/Aws/data/cognito-identity/2014-06-30/api-2.json.php',
    'Aws\data\cognito-identity\2014-06-30\docs-2.json' => __DIR__ . '/Aws/data/cognito-identity/2014-06-30/docs-2.json.php',
    'Aws\data\cognito-sync\2014-06-30\api-2.json' => __DIR__ . '/Aws/data/cognito-sync/2014-06-30/api-2.json.php',
    'Aws\data\cognito-sync\2014-06-30\docs-2.json' => __DIR__ . '/Aws/data/cognito-sync/2014-06-30/docs-2.json.php',
    ...
    'Aws\data\dynamodb\2012-08-10\docs-2.json' => __DIR__ . '/Aws/data/dynamodb/2012-08-10/docs-2.json.php',
    ...
    'Aws\data\elasticache\2015-02-02\docs-2.json' => __DIR__ . '/Aws/data/elasticache/2015-02-02/docs-2.json.php',
    ...
    'Aws\data\elasticbeanstalk\2010-12-01\docs-2.json' => __DIR__ . '/Aws/data/elasticbeanstalk/2010-12-01/docs-2.json.php',
    ...
    'Aws\data\elasticfilesystem\2015-02-01\docs-2.json' => __DIR__ . '/Aws/data/elasticfilesystem/2015-02-01/docs-2.json.php',
    ...
    'Aws\data\elasticmapreduce\2009-03-31\docs-2.json' => __DIR__ . '/Aws/data/elasticmapreduce/2009-03-31/docs-2.json.php',
    ...
    'Aws\data\elastictranscoder\2012-09-25\docs-2.json' => __DIR__ . '/Aws/data/elastictranscoder/2012-09-25/docs-2.json.php',
    ...
    'Aws\data\email\2010-12-01\docs-2.json' => __DIR__ . '/Aws/data/email/2010-12-01/docs-2.json.php',
    ...
    'Aws\data\kinesis\2013-12-02\docs-2.json' => __DIR__ . '/Aws/data/kinesis/2013-12-02/docs-2.json.php',
    ...
    'Aws\data\kms\2014-11-01\docs-2.json' => __DIR__ . '/Aws/data/kms/2014-11-01/docs-2.json.php',
    ...
    'Aws\data\lambda\2015-03-31\docs-2.json' => __DIR__ . '/Aws/data/lambda/2015-03-31/docs-2.json.php',
    ...
    'Aws\data\machinelearning\2014-12-12\docs-2.json' => __DIR__ . '/Aws/data/machinelearning/2014-12-12/docs-2.json.php',
    ...
    'Aws\data\opsworks\2013-02-18\docs-2.json' => __DIR__ . '/Aws/data/opsworks/2013-02-18/docs-2.json.php',
    ...
    'Aws\data\rds\2014-10-31\docs-2.json' => __DIR__ . '/Aws/data/rds/2014-10-31/docs-2.json.php',
    ...
    'Aws\data\redshift\2012-12-01\docs-2.json' => __DIR__ . '/Aws/data/redshift/2012-12-01/docs-2.json.php',
    ...
    'Aws\data\route53\2013-04-01\docs-2.json' => __DIR__ . '/Aws/data/route53/2013-04-01/docs-2.json.php',
    ...
    'Aws\data\route53domains\2014-05-15\docs-2.json' => __DIR__ . '/Aws/data/route53domains/2014-05-15/docs-2.json.php',
    ...
    'Aws\data\sns\2010-03-31\docs-2.json' => __DIR__ . '/Aws/data/sns/2010-03-31/docs-2.json.php',
    ...
    'Aws\data\sqs\2012-11-05\docs-2.json' => __DIR__ . '/Aws/data/sqs/2012-11-05/docs-2.json.php',
    ...
    'Aws\data\ssm\2014-11-06\docs-2.json' => __DIR__ . '/Aws/data/ssm/2014-11-06/docs-2.json.php',
    ...
    'Aws\data\streams.dynamodb\2012-08-10\docs-2.json' => __DIR__ . '/Aws/data/streams.dynamodb/2012-08-10/docs-2.json.php',
    'Aws\data\sts\2011-06-15\api-2.json' => __DIR__ . '/Aws/data/sts/2011-06-15/api-2.json.php',
    'Aws\data\sts\2011-06-15\docs-2.json' => __DIR__ . '/Aws/data/sts/2011-06-15/docs-2.json.php',
    ...
    'Aws\data\swf\2012-01-25\docs-2.json' => __DIR__ . '/Aws/data/swf/2012-01-25/docs-2.json.php',
    ...
    'Aws\data\waf\2015-08-24\docs-2.json' => __DIR__ . '/Aws/data/waf/2015-08-24/docs-2.json.php',
